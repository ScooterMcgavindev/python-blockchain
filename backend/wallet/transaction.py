...
class Transaction:
    ...
    def create_output(self, sender_wallet, recipient, amount):
        ...
        output[sender_wallet.address] = sender_wallet.balance - amount  # Change for the sender = address of previous wallet
    ...
    def create_input(self, sender_wallet, output):
        ...
        return {
            ...
            'amount': sender_wallet.balance,    # amt of currency sender had at time of transaction
    ...
    def from_json(transaction_json):
        """
        Deserialize a transaction's json representation bacck into a
